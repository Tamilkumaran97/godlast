        ...
        <div className="relative">
          ...
          <div className="absolute mx-aut0  w-[100%] h-[100vh] flex justify-center items-center">
            <div className="px-44 text-center">
              <h1 className="font-bold bold pb-2 text-white text-7xl">
          ...
          <div className="w-[100%] h-[100vh] absolute flex justify-between">
            <div>
              <motion.div className="floating1 w-44 h-44 bg-pink-500/50 rounded-2xl rotate-12"></motion.div>
              <motion.div className="floating w-24 h-24 bg-pink-300 rounded-2xl rotate-12"></motion.div>
            </div>
            <div className="rotate-180">
              <div className="floating1 w-44 h-44 bg-pink-500/50 rounded-full rotate-12"></div>
              <div className="floating w-24 h-24 bg-pink-300 rounded-full rotate-12"></div>
            </div>
          </div>
        </div>
      </div>

      <div className="w-[100%] mx-auto container h-[200vh]   p-5">
        <div className="text-center mx-auto">
          <h1 className="text-6xl font-bold p-10">Our Credentials</h1>
          <p>
        ...
        <div className="flex py-16">
          ...
          <div className="w-1/2 py-10  ">
            <div className="pb-6">
              <h1 className="text-4xl text-gray-500"> 100+ Project</h1>
              <p>
            ...
            <div>
              <h1 className="text-4xl text-gray-500"> 200+ clients</h1>
              <p>
                ...
                >
                  <div className="p-5">
                    ...
                    <p className="text-sm text-white lg:text-base ">
                      We designed a responsive website for this B2B company that
                      provide software solution to health care provides. The
                      website includes easy-to-use navigation, and a content
                      management system that allows the client to make update
                ...
                >
                  <div className=" p-5">
                    ...
                    <p className="text-sm lg:text-base ">
                      ...
                      website that is optimized for fundraising and engagement.
                      The website includes an integrated donation system, event
                      registration forms, and a blog for sharing updates and
                      news.
                    </p>
                  </div>
                </motion.div>
        ...
        <div className="flex">
          ...
          <div className="w-1/2 py-10 px-10">
            ...
            <li className="text-xl">Discover the best in your city.</li>
            <li className="text-xl">Source products & services nearby.</li>
            <li className="text-xl">Connect with reliable local businesses.</li>
          </div>
          <div className="w-1/2 py-10 px-10">
            <h1 className="text-3xl font-bold">Local Business</h1>
            <li className="text-xl">Improve your local reach & visibility.</li>
            <li className="text-xl">Get qualified local leads at no cost.</li>
            <li className="text-xl">Find new customers near you.</li>
          </div>
        </div>
      </div>
      <div>
