              ...
              <motion.div className="-mt-2 ">
                ...
                <div className="warp  ">
                  <Link
                    to="all"
                    smooth="true"
                    className="text-white absolute text-4xl z-50  animate-bounce -bottom-[580px]  lg:hidden  cursor-pointer"
                  >
                  ...
                  <Link
                    to="section"
                    smooth="true"
                    className="text-white -bottom-64 absolute text-4xl z-50  animate-bounce  lg:hidden cursor-pointer "
                  >
