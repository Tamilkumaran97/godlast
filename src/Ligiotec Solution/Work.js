...
const Work = () => {
  return (
    <section
      /*   id="two" */
      className="w-[100%]  bg-gradient-to-r from-gray-100 to-gray-300"
    >
      <div className="w-[100%]  relative overflow-hidden  h-[100vh] ">
        <Transition />
        <div className="relative">
          <div className="absolute mx-aut0 bg-gradient-to-r from-gray-100 to-gray-300 w-[100%] h-[100vh] flex justify-center items-center">
            <div className="lg:px-44 px-10 text-center">
              <h1 className="font-bold bold text-4xl pb-2 lg:text-8xl">
          ...
          >
            <div>
              <motion.div className="floating1 w-32 h-32 lg:w-44 lg:h-44 bg-orange-500/50 rounded-2xl rotate-12"></motion.div>
              <motion.div className="floating w-14 h-14 lg:w-24 lg:h-24 bg-orange-300 rounded-2xl rotate-12"></motion.div>
            </div>
            <div className="rotate-180">
              <div className="floating1 w-32 h-32 lg:w-44 lg:h-44 bg-orange-500/50 rounded-2xl rotate-12"></div>
              <div className="floating w-14 h-14 lg:w-24 lg:h-24 bg-orange-300 rounded-2xl rotate-12"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        id="one"
        className="w-[100%] relative hidden   lg:flex   container mx-auto"
      >
        <div
          data-scroll
          data-scroll-sticky
      ...
      {/**work small screen */}
      <div className="w-[100%] relative px-4 lg:hidden container mx-auto">
        <div
          /*     data-scroll
          data-scroll-sticky
          data-scroll-target="#one" */
        ...
        >
          <div>
            <motion.div className="floating1 w-16 h-16 bg-blue-500/30 rounded-2xl rotate-12"></motion.div>
            <motion.div className="floating w-24 h-24 bg-cyan-300/20 rounded-2xl rotate-12"></motion.div>
          </div>
          <div className="rotate-180">
            <div className="floating1 w-16 h-44 bg-yellow-500/30 rounded-full rotate-12"></div>
            <div className="floating w-24 h-24 bg-yellow-300/20 rounded-full rotate-12"></div>
          </div>
        </div>
        ...
        <div className="  py-">
          <div className="p-4">
            ...
            <div className="bg-black  h-[250px] container p-4 rounded-lg text-center ">
              <div className="text-white">
                <h1 className="text-xl md:text-3xl font-bold">
                  "Let's make something special"
                </h1>
                ...
                <button className="bg-blue-500 p-2  rounded-full text-black font-semibold">
                  {" "}
                  Start your project
                </button>
              </div>
        ...
        <div className=" px-2 py-16">
          ...
          <div className="">
            <div className="w-80 relative h-80 mx-auto my-10 bg-white">
              <img className="absolute" src={mobile} alt="" />
              <motion.div
                initial={{ opacity: 0 }}
                whileHover={{ opacity: 1 }}
            ...
            <div className="w-80 h-96 relati80 mx-auto my-10 bg-white">
              <img
                className="h-96 absolute w-96  object-cover"
                src={shoe}
                alt=""
